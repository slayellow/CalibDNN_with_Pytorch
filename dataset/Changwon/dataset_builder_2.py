...
for path, dirs, files in os.walk(dataset_path):
    for foldername in dirs:
        if not os.path.exists(dataset_path + foldername + "/depth_maps_2"):
            os.makedirs(dataset_path + foldername + "/depth_maps_2")
        if not os.path.exists(dataset_path + foldername + "/depth_maps_transformed_2"):
            os.makedirs(dataset_path + foldername + "/depth_maps_transformed_2")
        if not os.path.exists(dataset_path + foldername + "/target_images_2"):
            os.makedirs(dataset_path + foldername + "/target_images_2")
        ...
        for img_name, cloud_name in zip(imgs_files, point_files):
            ...
            smc.imsave(dataset_path + foldername + "/depth_maps_transformed_2" + "/" + imagefile, reprojected_img)
            ...
            smc.imsave(dataset_path + foldername + "/depth_maps_2" + "/" + imagefile, pooled_img)
            smc.imsave(dataset_path + foldername + "/target_images_2" + "/" + imagefile, reconstructed_img)

        np.savetxt(dataset_path + foldername + "/angle_list_2.txt", angle_list[1:], fmt = "%.4f")