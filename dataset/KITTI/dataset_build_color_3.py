...
if not os.path.exists(main_path + "_sync/depth_maps_3"):
    os.makedirs(main_path + "_sync/depth_maps_3")

if not os.path.exists(main_path + "_sync/target_imgs_3"):
    os.makedirs(main_path + "_sync/target_imgs_3")

if not os.path.exists(main_path + "_sync/depth_maps_transformed_3"):
    os.makedirs(main_path + "_sync/depth_maps_transformed_3")

depth_maps_folder = main_path + "_sync/depth_maps_3"
target_img_folder = main_path + "_sync/target_imgs_3"
depth_maps_transformed_folder = main_path + "_sync/depth_maps_transformed_3"
...
pointcloud_file = open(depth_maps_transformed_folder + "/../pointcloud_list_3.txt", 'w')
...
np.savetxt(depth_maps_transformed_folder + "/../angle_list_3.txt", angle_list[1:], fmt = "%.4f")
