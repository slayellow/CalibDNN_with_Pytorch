...
for i_batch, sample_bathced in enumerate(valid_loader):
    ...
    # smc.imsave(
    #     cf.paths["inference_img_result_path"] + "/Pretrained_Changwon_ChangwonDatset_Target.png",
    #     reprojected_img)
    # smc.imsave(cf.paths["inference_img_result_path"] + "/Pretrained_Changwon_ChangwonDatset_Predicted.png",
    #            projected_img)
