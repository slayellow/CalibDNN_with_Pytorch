...
for image_file, depth_map, pointfile in zip(AICamera_image, AICamera_Point, transforms_list):
    ...
    smc.imsave(cf.paths['inference_img_result_path'] + "/Pretrained_Changwon_ChangwonTestData_Target.png", reprojected_img)
    ...
    smc.imsave(cf.paths['inference_img_result_path'] + "/Pretrained_Changwon_ChangwonTestData_Predicted.png", projected_img)
    break
